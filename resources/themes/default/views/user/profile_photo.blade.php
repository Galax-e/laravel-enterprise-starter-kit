	...
	<div class="tab-pane" id="tab_pix">
	    <div class="form-group">
	        <div class="box-body no-padding">
	            <img src="{{ asset('/img/profile_picture/photo/'.Auth::user()->avatar) }}" class="offline" style="width: 150px; height: 150px; float: left; border-radius: 50%; margin-right: 25px;" alt="User Image"/>
